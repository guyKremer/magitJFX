...
public class Repository {
    ...
    private void GetHeadBranchCommitHistoryRec(List<Commit> i_res,String i_sha1)throws IOException {
        ...
        if(commitToInsert.getPrevCommitSha1()!=null){
            GetHeadBranchCommitHistoryRec(i_res,commitToInsert.getPrevCommitSha1());
        }
    }
    ...
    public void createCommit(String i_message)throws FileAlreadyExistsException,java.io.IOException {
        ...
        m_currentCommit = new Commit(i_message,m_WC,m_currentCommit!=null?m_currentCommit.getSha1():null
    ...
    public void readPartialCommitLines(List<String> i_lines,Commit i_commit){
        ...
        for (int i=0; i < i_lines.size(); i++) {
            switch(i){
                ...
                case 1:i_commit.setM_prevCommitSha1(i_lines.get(i));
                break;

                case 2:i_commit.setM_message(i_lines.get(i));
                break;

                case 3: i_commit.setM_dateOfCreation(i_lines.get(i));
                break;

                case 4:i_commit.setM_creator(i_lines.get(i));
            }
        }
