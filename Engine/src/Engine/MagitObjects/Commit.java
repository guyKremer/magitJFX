...
public class Commit {
    ...
    public Commit(String i_message, Folder i_root, String i_prevCommitSha1,
                  String i_dateOfCreation, String i_creator)
    {
        m_message=i_message;
        m_rootFolder=i_root;
        m_rootFolder.saveInObjects();
        m_prevCommitSha1=i_prevCommitSha1;
    ...
    public String getPrevCommitSha1(){return m_prevCommitSha1;}
    ...
    public void setM_prevCommitSha1(String i_sha1){
        if(i_sha1.equals("null")){
            m_prevCommitSha1=null;
        }
        else{
            m_prevCommitSha1=i_sha1;
        }
    }
    ...
    public void Commit(Folder i_WC,String i_message,String i_dateOfCreation,String i_user, String i_prevCommitSha1){
    ...
    public String createSha1() {
        ...
        commitContent.append(m_rootFolder.getSha1() + m_prevCommitSha1
    ...
    public void readPartialCommitLines(List<String> i_lines){
        ...
        for (int i=0; i < i_lines.size(); i++) {
            switch(i){
                ...
                case 1:setM_prevCommitSha1(i_lines.get(i));
                    break;

                case 2:setM_message(i_lines.get(i));
                    break;

                case 3: setM_dateOfCreation(i_lines.get(i));
                    break;

                case 4:setM_creator(i_lines.get(i));
            }
        }
    ...
    public String toString() {
        ...
        string.append(m_prevCommitSha1);
        string.append(System.getProperty("line.separator"));
